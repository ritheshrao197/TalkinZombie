...
public class GameController : MonoBehaviour {
	public static Action<float> OnPitchValueChanged;
    ...
    internal static void OnThresholdValueChanged(float value)
    {
		GameConstants.SoundThreshold = value;
